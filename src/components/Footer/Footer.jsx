...
import "./Footer.css";
import Logo from "../../assets/MathCodeLogo.jpg"
  ...
  const onSubscribe = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://us-central1-mathcode-1c100.cloudfunctions.net/subscribeEmail",
        {
          method: "POST",
          ...
          <div className="col newsletter">
            ...
            <form onSubmit={onSubscribe} className="newsletter-form">
              <input
                ...
                name="email"
                required
                placeholder="learn@mathcode.com"
                disabled={sending}
              />
              <button className="btn-subscribe" type="submit" disabled={sending}>
                {sending ? "Subscribing..." : "Subscribe"}
              </button>
            </form>

            {ok && <p className="note success">🎉 Subscribed! Check your inbox.</p>}
